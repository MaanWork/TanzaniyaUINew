...
wallMaterialList:any[]=[];roofMaterialList:any[]=[];public productItem: ProductData = null
  ...
  sectionCount: number;currentContentRowIndex=null;
  currentBuildingRowIndex=null;
  coversreuired: any;
...
getTotal(){
  ...
  getTotalBuilding(){
    this.Total = 0;let i=0;
    if(this.TableRowBuilding.length!=0 && ((this.coversreuired=='C' || this.coversreuired=='BC') && this.Building1)){
        ...
        editsections(types){
          ...
          EndtPrevPolicyNo=null,EndtPrevQuoteNo=null,EndtStatus=null,IsFinanceEndt=null,OrginalPolicyNo=null;
            ...
            {   "SectionId": "35",
              ...
              if((this.coversreuired=='C' || this.coversreuired=='BC')){
