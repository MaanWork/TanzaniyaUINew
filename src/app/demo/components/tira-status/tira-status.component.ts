...
export class TiraStatusComponent {
  ...
  ngOnInit(): void {
    //this.getProductList();
    this.tiraHeader = ['Request Id' ,'Response Id' ,'TIRA Code','Tracking Id' ,'Hit Count' ,'Status' ,'Entry Date' ,
      'Method Name' ,'Request', 'Response','Acknowledge Details',
    ];
this.issuerHeader = [
  'QuoteNo', 'Customer Name',  'PolicyNo' , 'Response Status' , 'Response StatusCode' , 'LoginId' , 'Tira RequestId' ,  'Tira ResponseId' , 'ReHit', 'View', 
];
