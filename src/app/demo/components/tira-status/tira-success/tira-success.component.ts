...
@Component({
  selector: 'app-tira-success',
  templateUrl: './tira-success.component.html',
  styleUrls: ['./tira-success.component.scss']
})
export class TiraSuccessComponent {
  ...
  ngOnInit(): void {
   //this.getalldetails();
    this.issuerHeader = ['QuoteNo', 'Customer Name' , 'Policy No' , 'Response Status' ,'Response StatusCode' ,
       'Login Id' , 'Branch' ,'Tira RequestId' , 'Tira ResponseId' ,'View',
      ];
      this.tiraHeader = ['RequestId','ResponseId', 'TIRA Code', 'Tracking Id' ,'Hit Count' ,'Status','Entry Date','Method Name' ,'Request','Response'
      ];
